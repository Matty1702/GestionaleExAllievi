...
namespace GestioneExAllievi.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Utente con Id '{UserId}' ha abilitato 2FA con un'app di autenticazione.", userId);
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(GestioneExAllieviUser user)
        {
