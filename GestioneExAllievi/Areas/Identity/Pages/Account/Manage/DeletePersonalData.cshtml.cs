...
namespace GestioneExAllievi.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!result.Succeeded)
            {
                throw new InvalidOperationException($"Si è verificato un errore imprevisto durante l'eliminazione dell'utente.");
            }

            await _signInManager.SignOutAsync();

            _logger.LogInformation("Utente con Id '{UserId}' si è cancellato.", userId);
