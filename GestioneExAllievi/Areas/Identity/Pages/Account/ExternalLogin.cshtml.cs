...
namespace GestioneExAllievi.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} effettuato l'accesso con {LoginProvider} provider.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        private GestioneExAllieviUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Impossibile creare un'istanza di '{nameof(GestioneExAllieviUser)}'. " +
                    $"Assicurati che '{nameof(GestioneExAllieviUser)}' non sia una classe astratta e abbia un costruttore senza parametri, oppure " +
        ...
        private IUserEmailStore<GestioneExAllieviUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("L'interfaccia utente predefinita richiede uno store utenti con supporto per l'email.");
            }
