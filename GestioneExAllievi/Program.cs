...
builder.Services.AddDefaultIdentity<GestioneExAllieviUser>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<GestioneExAllieviContext>();
